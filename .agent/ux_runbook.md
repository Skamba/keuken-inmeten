...
The latest counted evidence set is `.agent/screenshots/iteration-8/`.
...
For the Verificatie completion decision point, use `.agent/screenshots/iteration-8/after/comparisons/verificatie-completion-card-desktop-comparison.png`.
