...
public static class TerminologieHelper
{
    ...
    private static readonly IReadOnlyDictionary<string, TerminologieTerm> Termen = new Dictionary<string, TerminologieTerm>
    {
        ...
        ["werkmaat"] = new(
            ...
            "Een opening van 597 mm met 2 mm speling links en rechts wordt 593 mm werkmaat.",
        ...
        ["randspeling"] = new(
            ...
            "2 mm links en 2 mm rechts betekent samen 4 mm minder paneelbreedte dan de opening.",
